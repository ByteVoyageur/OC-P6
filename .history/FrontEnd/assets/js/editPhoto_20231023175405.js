...
function createAddPhotoModal() {
  ...
  let existingModal = document.getElementById('editModalOverlay')
  if (existingModal) {
    existingModal.remove() // Remove the existing modal if it's there
  }
  ...
  editModalAddPhotoButton.id = 'photoFileInput' // Updated the ID
  editModalAddPhotoButton.classList.add('hidden-upload')

  const customUploadLabel = document.createElement('label')
  customUploadLabel.setAttribute('for', 'photoFileInput') // Updated the 'for' attribute
  ...
  editModalAddPhotoFormTitle.setAttribute('for', 'photoTitleInput') // Updated the 'for' attribute
  const editModalAddPhotoFormTitleInput = document.createElement('input')
  editModalAddPhotoFormTitleInput.type = 'text'
  editModalAddPhotoFormTitleInput.id = 'photoTitleInput'
  ...
  editModalAddPhotoFormCategory.setAttribute('for', 'categoryDropdown') // Updated the 'for' attribute
  const editModalAddPhotoFormCategoryInput = document.createElement('select')
  editModalAddPhotoFormCategoryInput.id = 'categoryDropdown'
  ...
  validateButton.id = 'submitButton' // Updated the ID
  ...
  // Initialize the logic for this modal
